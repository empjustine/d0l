type D0LSymbol = string;
type D0L = DeterministicContextFreeStringRewritingSystem;
 ...
 * 
 */
class DeterministicContextFreeStringRewritingSystem {
     ...
     * function.
     */
    private productions : Map<D0LSymbol, Array<D0LSymbol>>;
    ...
    derive(previousGeneration: string) : string {
        ...
        return [...(previousGeneration)].map(
            v => productions.get(v)
        ).join('')
    }
}

module.exports = DeterministicContextFreeStringRewritingSystem